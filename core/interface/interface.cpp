...
auto m_interface::c_interface::draw_interface( ) -> void 
{
	...
	//	
	//	framework.get( )->text( "FLAWLESS", position.x + 47.0f, position.y + 11.0f, framework.get( )->get_color( 255, 255, 255, 255 ), 20, false, font_weight::m_medium, true );
...
auto m_interface::c_interface::get_cursor( ) -> uemath::fvector2d {
	...
	return uemath::fvector2d( float( CursorPoint.x ), float( CursorPoint.y ) );
}
