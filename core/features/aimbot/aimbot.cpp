...
//
//	// Calculate yaw
//	float yaw = atan2(direction.y, direction.x) * (180.0 / std::numbers::pi); // Convert radians to degrees
//
//	// Invert the pitch calculation if necessary
//	float pitch = atan2(direction.z, sqrt(direction.x * direction.x + direction.y * direction.y)) * (180.0 / std::numbers::pi); // Convert radians to degrees
//
